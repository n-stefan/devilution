...
void gamemenu_sound_music_toggle(const char **names, TMenuItem *menu_item, int gamma);
...
/* rdata */
extern const char *music_toggle_names[];
extern const char *sound_toggle_names[];
extern const char *color_cycling_toggle_names[];
