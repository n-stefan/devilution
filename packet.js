...
function read_packet(reader, types) {
...
module.exports = {read_packet, write_packet, server_packet, client_packet, buffer_reader, buffer_writer, RejectionReason};
